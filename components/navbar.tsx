...
export default function Navbar() {
  ...
  useEffect(() => {
    ...
    if (!hasVisited) {
      setTimeout(() => {
        addNotification("success", "Welcome to FutsalConnectPro!", "Find and book the best futsal courts in your area.")
      ...
      <div className="container mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            <Link href="/venues" className="text-gray-700 hover:text-green-600 font-medium">
              Find Venues
            </Link>
            ...
            <Link href="/register-venue" className="text-gray-700 hover:text-green-600 font-medium">
              List Your Venue
            </Link>
              ...
              <DropdownMenuContent align="end" className="w-80">
                {notifications.length > 0 ? (
                  notifications.map((notification) => (
                    <DropdownMenuItem key={notification.id} className="p-3 border-b last:border-0">
                      <div>
                  ...
                  <DropdownMenuItem className="p-3 text-center">No notifications</DropdownMenuItem>
                )}
              </DropdownMenuContent>
            </DropdownMenu>
            <Link href="/login">
