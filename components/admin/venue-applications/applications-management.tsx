...
import { useGetVenueApplicationsQuery, useUpdateVenueApplicationStatusMutation } from "@/redux/api/venueApplicationsApi"
...
export function ApplicationsManagement() {
  const { data: applications, isLoading, isError } = useGetVenueApplicationsQuery()
  ...
  return (
    <div className="space-y-6">
      <Card>
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Venue Applications</CardTitle>
          <p className="text-muted-foreground">Review and manage venue registration applications</p>
        </CardHeader>
        <CardContent>
                  ...
                  applications.map((application) => {
                    ...
                    return (
                      <TableRow key={application.ID} className="hover:bg-muted/50">
                        <TableCell className="font-medium">{application.VenueName}</TableCell>
