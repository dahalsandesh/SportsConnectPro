    ...
    try {
      ...
      try {
        ...
        toast({
          ...
          description:
            "Image uploaded, but there was an issue refreshing the page. Please refresh manually.",
          variant: "default",
        });
      }
    } catch (error) {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage your venue details, courts, and more
          </p>
        </div>
          ...
          <Card>
            <CardHeader>
              <div className="flex items-center justify-between">
                ...
                <Button size="sm" onClick={() => setIsAddCourtDialogOpen(true)}>
                  ...
                  {courts.map((court: any) => (
                    ...
                    >
                      <div className="aspect-video bg-muted/50 relative">
                        {court.courtImage?.[0] ? (
                          <img
                            src={getImageUrl(court.courtImage[0])}
                            alt={court.courtName}
                            className="w-full h-full object-cover"
                          />
                        ) : (
                      ...
                      <div className="p-4">
                        ...
                        <div className="mt-2 space-y-1 text-sm">
                          ...
                          <div className="flex items-center text-muted-foreground">
                            ...
                            <span className="font-medium">
                              Rs {court.hourlyRate?.toLocaleString() || "0"}
                              /hour
                            </span>
                          </div>
                        </div>
